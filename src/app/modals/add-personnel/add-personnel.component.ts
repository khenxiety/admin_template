...
export class AddPersonnelComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private toast: ToastrService,private mat:MatDialog,private firestore:Firestore,public dialogRef: MatDialogRef<AddPersonnelComponent>,@Inject(MAT_DIALOG_DATA) public data:any) { }
