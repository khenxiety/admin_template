...
@Component({
  selector: 'app-personnel-degree-table',
  templateUrl: './personnel-degree-table.component.html',
  styleUrls: ['./personnel-degree-table.component.scss'],
})
export class PersonnelDegreeTableComponent implements AfterViewInit {
