...
@Component({
  selector: 'app-jobpersonnel-temporary-alldata',
  templateUrl: './jobpersonnel-temporary-alldata.component.html',
  styleUrls: ['./jobpersonnel-temporary-alldata.component.scss']
})
export class JobpersonnelTemporaryAlldataComponent implements AfterViewInit {
  ...
  fileName: any = 'Job Personnel List Form A (Casual Non Teaching).xlsx';
