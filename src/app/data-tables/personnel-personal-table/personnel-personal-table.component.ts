...
@Component({
  selector: 'app-personnel-personal-table',
  templateUrl: './personnel-personal-table.component.html',
  styleUrls: ['./personnel-personal-table.component.scss']
})
export class PersonnelPersonalTableComponent implements AfterViewInit {
