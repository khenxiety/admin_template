...
@Component({
  selector: 'app-faculty-guest-degree',
  templateUrl: './faculty-guest-degree.component.html',
  styleUrls: ['./faculty-guest-degree.component.scss']
})
export class FacultyGuestDegreeComponent implements AfterViewInit {
  ...
  exportexcel(): void 
    {
      ...
      // remove column
       ...
       /* save to file */
       XLSX.writeFile(wb, 'Faculty List Form C (Guest Lecturer).xlsx');
       location.reload();
