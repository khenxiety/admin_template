...
@Component({
  selector: 'app-faculty-degree-table',
  templateUrl: './faculty-degree-table.component.html',
  styleUrls: ['./faculty-degree-table.component.scss']
})
export class FacultyDegreeTableComponent implements AfterViewInit {
  ...
  exportexcel(): void 
    {
      ...
      // remove column
       ...
       /* save to file */
       XLSX.writeFile(wb, 'Faculty List Form C (Permanent Lecturer).xlsx');
    location.reload();
