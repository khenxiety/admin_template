...
@Component({
  selector: 'app-jobpersonnel-temporary-personal',
  templateUrl: './jobpersonnel-temporary-personal.component.html',
  styleUrls: ['./jobpersonnel-temporary-personal.component.scss']
})
export class JobpersonnelTemporaryPersonalComponent implements AfterViewInit {
  ...
  exportexcel(): void 
    {
      ...
      // remove column
       ...
       /* save to file */
       XLSX.writeFile(wb, 'Job Personnel List Form B (Permanent Non Teaching).xlsx');
    location.reload();
