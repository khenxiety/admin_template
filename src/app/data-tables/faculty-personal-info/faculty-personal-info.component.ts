...
@Component({
  selector: 'app-faculty-personal-info',
  templateUrl: './faculty-personal-info.component.html',
  styleUrls: ['./faculty-personal-info.component.scss']
})
export class FacultyPersonalInfoComponent implements AfterViewInit {
  ...
  exportexcel(): void {
      ...
      // remove column
       ...
       /* save to file */
      XLSX.writeFile(wb, 'Faculty List Form B (Permanent Lecturer).xlsx');
    location.reload();
