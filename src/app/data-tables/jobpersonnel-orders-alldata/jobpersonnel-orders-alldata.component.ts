...
@Component({
  selector: 'app-jobpersonnel-orders-alldata',
  templateUrl: './jobpersonnel-orders-alldata.component.html',
  styleUrls: ['./jobpersonnel-orders-alldata.component.scss']
})
export class JobpersonnelOrdersAlldataComponent implements AfterViewInit {
  ...
  fileName: any = 'Job Personnel List Form A (Job Orders).xlsx';
