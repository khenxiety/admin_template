...
@Component({
  selector: 'app-jobpersonnel-orders-degree',
  templateUrl: './jobpersonnel-orders-degree.component.html',
  styleUrls: ['./jobpersonnel-orders-degree.component.scss']
})
export class JobpersonnelOrdersDegreeComponent implements AfterViewInit {
  ...
  exportexcel(): void {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'Job Personnel List Form C (Job Orders).xlsx');
    location.reload();
