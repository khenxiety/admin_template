...
@Component({
  selector: 'app-faculty-temporary-personal',
  templateUrl: './faculty-temporary-personal.component.html',
  styleUrls: ['./faculty-temporary-personal.component.scss']
})
export class FacultyTemporaryPersonalComponent implements AfterViewInit {
  ...
  exportexcel(): void {
      ...
      // remove column
       ...
       /* save to file */
      XLSX.writeFile(wb, 'Faculty List Form B (Temporary Lecturer).xlsx');
    location.reload();
