...
@Component({
  selector: 'app-faculty-guest-alldata',
  templateUrl: './faculty-guest-alldata.component.html',
  styleUrls: ['./faculty-guest-alldata.component.scss']
})
export class FacultyGuestAlldataComponent implements AfterViewInit {
  ...
  fileName = 'Faculty List Form A (Guest Lecturer).xlsx';
