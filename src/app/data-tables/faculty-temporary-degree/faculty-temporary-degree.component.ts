...
// import { FacultyDegreeTableDataSource, FacultyDegreeTableItem } from './faculty-degree-table-datasource';
...
@Component({
  selector: 'app-faculty-temporary-degree',
  templateUrl: './faculty-temporary-degree.component.html',
  styleUrls: ['./faculty-temporary-degree.component.scss']
})
export class FacultyTemporaryDegreeComponent implements AfterViewInit {
  ...
  exportexcel(): void 
    {
       ...
       let element = document.getElementById('faculty-degree'); 
      ...
      // remove column
       ...
       /* save to file */
       XLSX.writeFile(wb, 'Faculty List Form C (Temporary Lecturer).xlsx');
    location.reload();
