...
@Component({
  selector: 'app-faculty-temporary-alldata',
  templateUrl: './faculty-temporary-alldata.component.html',
  styleUrls: ['./faculty-temporary-alldata.component.scss']
})
export class FacultyTemporaryAlldataComponent implements AfterViewInit {
  ...
  fileName = 'Faculty List Form A (Temporary Lecturer).xlsx';
